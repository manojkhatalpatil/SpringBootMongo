...
public class CustomerController {
    ...
    public ResponseEntity<Optional<Customer>> updateData(@PathVariable int custId, @RequestBody Customer customer){
         Customer customer1 = customerServiceImpl.getDataById(custId).orElseThrow(()-> new RecordNotFoundException("Id Dose Not Exits"));
         ...
         return ResponseEntity.ok(Optional.ofNullable(customerServiceImpl.updateData(customer1)));
    }
